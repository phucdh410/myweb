...
const UpdateCenterInstitutePage = () => {
  useTitle('Cập nhật Trung tâm');
  //#region Data
  ...
  const onSubmit = () => {
    handleSubmit(async (values) => {
      try {
        ...
        toast.success(toastMessage('trung tâm').SUCCESS.UPDATE);
        onCancel();
      } catch (error: any) {
        toast.error(
          error?.response?.data?.message ||
            toastMessage('trung tâm').ERROR.UPDATE,
        );
      }
    })();
  };
...
export default UpdateCenterInstitutePage;
