...
import { deleteTimeline } from '@/apis/institutes.api';
import { CFormLabel } from '@/controls/';
import { toastMessage } from '@/funcs/';
import { CenterInstituteContext } from '@/modules/institutes/context';
...
export const MTimelineForm = ({ department_id, data }: IMTimelineFormProps) => {
  //#region Data
  const refetch = useContext(CenterInstituteContext);
