...
import { createSubject, updateSubject } from '@/apis/departments.api';
...
import { defaultValues, subjectResolver } from '../form';
...
export const MFormModal = forwardRef<IMFormModalRef, IMFormModalProps>(
  ({ departmentId, refetch }, ref) => {
    ...
    const { control, handleSubmit, reset } =
      useForm<ICreateOrUpdateSubjectParams>({
        mode: 'all',
