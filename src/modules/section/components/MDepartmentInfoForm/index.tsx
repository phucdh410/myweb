...
import { IMDepartmentInfoFormProps } from './types';

export const MDepartmentInfoForm: React.FC<IMDepartmentInfoFormProps> = ({
  control,
  image,
}) => {
  return (
      ...
      <Stack direction="row" spacing={5} mb={3}>
        ...
        <Stack direction="column" spacing={2.5} flex={0.3}>
          <Stack direction="column" spacing={1} flex={1}>
            <CFormLabel label="Ảnh logo" required htmlFor="files" />
            <Controller
              control={control}
              name="files"
              render={({ field, fieldState: { error } }) => (
