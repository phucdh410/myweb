...
import { deleteTimeline } from '@/apis/department-functions.api';
import { CFormLabel } from '@/controls/';
import { toastMessage } from '@/funcs/';
import { DepartmentFunctionContext } from '@/modules/functions/context';
...
export const MTimelineForm = ({ department_id, data }: IMTimelineFormProps) => {
  //#region Data
  const refetch = useContext(DepartmentFunctionContext);
